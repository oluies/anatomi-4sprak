...
def test_new_language_reaches_the_deck(repo):
    ...
    # de befintliga fälten får inte byta namn — då bryts användarnas kort
    for stable in ["Svenska", "Latin", "Ukrainska", "Ryska", "DefSv", "DefUk", "DefRu", "Kategori"]:
        assert stable in fields, f"fältet {stable} försvann"
